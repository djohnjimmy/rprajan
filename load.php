...
<body>
	...
	<p>
		...
		use this application. Thanks!
	</p>

	<p>&nbsp;</p>
	<p>&nbsp;</p>
	<p>
		<br /> Do you want to upload a file?
	</p>
	<form action="loadStocks.php" method="post"
		enctype="multipart/form-data">
		<label for="file">Filename:</label> <input type="file" name="stocks"
	...
	<p>If you want to pull from the website, please select date for which
		to pull.</p>
	<form action="pullFromNSEOO.php" method="post"
		enctype="multipart/form-data">

		<label for="file">Pull file for date :</label> <input type="text"
			id="datepicker" name="datepicker"> <input type="submit"
			value="Submit">
